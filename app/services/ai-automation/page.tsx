...
import { ArrowLeft, CheckCircle, Bot, Zap, Workflow, BarChart } from "lucide-react"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"
import { Button } from "@/components/ui/button"

export const metadata: Metadata = {
  title: "AI Automation Workflows - Fresh Digital Creations",
  description: "Streamline operations with intelligent automation solutions. Workflow automation, AI chatbots, LLM integration, and data pipeline automation.",
}
...
export default function AIAutomationPage() {
  ...
  const benefits = [
    ...
    },
    {
      icon: Bot,
      title: "AI Chatbots",
      description: "24/7 customer support with intelligent chatbots that understand context."
    },
    {
      icon: Zap,
      title: "Smart Integration",
      description: "Connect all your tools and systems with intelligent automation workflows."
    },
    {
      icon: BarChart,
      title: "Data Insights",
      description: "Automated data processing and analysis for better business decisions."
    }
  ]
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">
              What's Included in Our AI Automation Service
            </h2>
        ...
        <div className="container">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Let's streamline your operations with intelligent AI automation. 
